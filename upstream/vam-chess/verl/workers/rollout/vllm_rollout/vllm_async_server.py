...
try:
    ...
    # vLLM 0.8.x does not export get_tcp_uri; newer releases do.
...
class vLLMHttpServerBase:
    ...
    async def run_server(self, args: argparse.Namespace):
        ...
        # Older vLLM builds do not expose reset_mm_cache on AsyncLLM.
    ...
    async def run_headless(self, args: argparse.Namespace):
        if CoreEngineProcManager is None:
            raise RuntimeError("Multi-node vLLM server mode requires a newer vLLM build with CoreEngineProcManager.")
