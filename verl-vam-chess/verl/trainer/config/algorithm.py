...
__all__ = ["AlgoConfig", "DiversityConfig", "FilterGroupsConfig", "KLControlConfig"]
...
@dataclass
class DiversityConfig(BaseConfig):
    """Configuration for diversity auxiliary advantages in GRPO.

    Args:
        enable (bool): Whether to enable diversity auxiliary advantages.
        method (str): Diversity method to use: "none", "obe_batch", "gapo", or "distinct_k".
        lambda_coeff (float): Scalar lambda used to combine base and diversity advantages.
        distinct_k (int): Subset size k used by the Distinct@k analytic method.
        include_base_advantage (bool): Whether to keep base GRPO/Pass@k advantages in final combination.
    """
    ...
    distinct_k: int = 4
    include_base_advantage: bool = True
...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        pass_k_training (bool): Whether to use Pass@k max-subset advantages in the GRPO branch.
        pass_k_k (int): Pass@k subset size k used when pass_k_training is enabled.
        ...
        diversity (DiversityConfig): Diversity auxiliary-advantage configuration for GRPO.
